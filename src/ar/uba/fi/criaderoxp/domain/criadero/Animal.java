...
public abstract class Animal {
	...
	public void juntar(String descripcion, Animal pareja) {
		...
		// Evalúo la condición para no quedar en una recursión indirecta infinita con pareja.juntar()
	 ...
	 * 
	 * @param estaPreniada
	 *            Si es {@link Boolean#TRUE}, deja al animal en estado "Preñado", si no, "En espera"
	 */
	public void diagnosticar(String descripcion, Boolean estaPreniada) {
		...
		this.registro.addEvento(TipoEventoHelperQUITAR.diagnostico, descripcion);
		this.estado = nuevoEstado;
	}
	...
	public void destetarCrias(String descripcion) {
		...
		this.registro.addEvento(TipoEventoHelperQUITAR.desteteCrias, descripcion);
